  ...
  articles = [
    {
      ...
      description: 'For many students, going to college can be synonymous with experiencing high levels of stress. While a ....',
    ...
    },
    {
      ...
      description: 'At its core, ambition can be a compelling force that motivates individuals to chase their goals and strive for success. It often plays an important role in personal growth, self-improvement, and achievement.....',
